...
python -m torch.distributed.launch \
    --nproc_per_node 4 \
    src/main.py \
        --data_dir '/local/coref_entity_linking/data/BC5CDR-c/' \
        --model_type 'bert' \
        --model_name_or_path 'models/biobert_v1.1_pubmed/' \
        --task_name 'cluster_linking' \
        --output_dir '/mnt/nfs/scratch1/rangell/lerac/coref_entity_linking/experiments/BC5CDR-c/cluster_linking/exp_0_m-e/' \
