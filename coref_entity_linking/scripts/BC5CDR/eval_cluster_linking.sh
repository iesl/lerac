...
python -m torch.distributed.launch \
    ...
    src/main.py \
        ...
        --model_type 'bert' \
        --trained_model_dir '/mnt/nfs/scratch1/rangell/lerac/coref_entity_linking/experiments/BC5CDR/cluster_linking/exp_1/checkpoint-796/' \
        --task_name 'cluster_linking' \
        --output_dir '/mnt/nfs/scratch1/rangell/lerac/coref_entity_linking/experiments/BC5CDR/cluster_linking/exp_1/checkpoint-796/' \
